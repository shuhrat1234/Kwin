...
const Translations = {
    en: {
        ...
        og_title: 'KWIN Tijorat - Your Reliable Auto Parts Partner in Uzbekistan',
        ...
        about_content: 'Since 2005, KWIN Tijorat has been successfully developing the Uzbekistan auto components market, offering our clients only proven products from leading global manufacturers. Over the years, we have established ourselves as a reliable supplier and partner, earning the trust of thousands of clients and numerous companies across various regions of the country. KWIN Tijorat is the official distributor of brands such as Heyner (Germany), Alca (Germany), Utal (Poland), ARS (Russia), and Delta (Russia). We take pride in representing products, that combine innovation, durability, and high quality, meeting international standards.',
        our: 'Our',
    ...
    ru: {
        ...
        og_title: 'KWIN Tijorat - Ваш Надежный Партнер по Автозапчастям в Узбекистане',
    ...
    ger: {
        ...
        about_content: 'Seit 2005 entwickelt KWIN Tijorat erfolgreich den usbekischen Markt für Autokomponenten und bietet unseren Kunden nur bewährte Produkte von führenden globalen Herstellern an. Im Laufe der Jahre haben wir uns als zuverlässiger Lieferant und Partner etabliert und das Vertrauen von Tausenden von Kunden und zahlreichen Unternehmen in verschiedenen Regionen des Landes gewonnen. KWIN Tijorat ist der offizielle Distributor von Marken wie Heyner (Deutschland), Alca (Deutschland), Utal (Polen), ARS (Russland) und Delta (Russland). Wir sind stolz darauf, Produkte zu vertreten, die Innovation, Langlebigkeit und hohe Qualität vereinen und internationalen Standards entsprechen.',
        our: 'Unsere',
